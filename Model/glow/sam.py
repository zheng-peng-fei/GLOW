...
parser.add_argument(
    "--n_flow", default=40, type=int, help="number of flows in each block"
)
...
if __name__ == "__main__":
    ...
    model.load_state_dict(torch.load("checkpoint/model_015001.pt"))
    ...
    for k in range(100): 
        ...
        _,_,zouts=model.module.forward(image)
        del image
        print(torch.cuda.memory_allocated())
        all_noise.append((zouts[0]*80).detach().cpu().numpy())
